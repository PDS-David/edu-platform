...
`.trim();
  ...
  // POLICY: this question was generated by AI on a student's behalf (gap-fill
  // for practice). ALL AI-generated questions must be reviewed by an admin in
  // the Question Review Queue before they reach any student-facing quiz or
  // practice session — status is therefore 'pending', not 'approved'. This
  // question will not appear in GET /api/questions/random,
  // /api/courses/:id/assessments, or the quiz generator until an admin
  // approves it from the Review Queue.
