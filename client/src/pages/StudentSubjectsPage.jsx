...
// Phase 3: self-service add/unenrol removed — exam type and subjects are
// now assigned by the student's school or App Admin
// (see server/routes/schoolRoutes.js POST /students/:studentId/assign-exam-type).

import { useState, useEffect } from 'react';
import { useNavigate, Link } from 'react-router-dom';
import api from '../services/apiClient';
import {
  BookOpen, Loader2, ArrowLeft, ChevronRight,
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#f9f7f4]">
      ...
      <div className="max-w-xl mx-auto px-4 py-6">
        ...
        {/* Phase 3: self-service subject management is locked down — exam
            type and subjects are now assigned by the student's school or
            App Admin. The old "Add Subject" button (which linked to
            /student/exam-types) is removed here; that page's self-add form
            is itself disabled below. */}
        <div className="mb-5 text-xs text-gray-400 bg-gray-50 border border-gray-100 rounded-xl px-4 py-3">
          Your exam type and subjects are managed by your school or app administrator.
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-16 border border-dashed border-gray-200 rounded-2xl">
            ...
            <p className="text-xs text-gray-400 mb-4">Contact your school or app admin to get started.</p>
          </div>
